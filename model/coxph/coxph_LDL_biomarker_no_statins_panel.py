...
class PointEstimateEvaluator:
    ...
    def run_analysis(self):
        ...
        if all_results:
            ...
            results_filename = os.path.join(self.cindex_save_dir, "cindex_LDL_biomarker_no_statins_panel_summary.csv")
...
if __name__ == '__main__':
    ...
    log_filename = os.path.join(LOG_DIR, "CoxPH/Point_Estimates_LDL_Biomarker_No_Statins_PANEL.log")
