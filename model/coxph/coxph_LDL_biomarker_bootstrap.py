...
class BootstrapEvaluator:
    ...
    def run_analysis(self):
        ...
        if all_results:
            ...
            results_filename = os.path.join(self.save_dir, "cindex_LDL_biomarker_bootstrap_ci_summary.csv")
...
if __name__ == '__main__':
    ...
    log_filename = os.path.join(LOG_DIR, "CoxPH/Bootstrap_CI_LDL_Biomarker.log")
