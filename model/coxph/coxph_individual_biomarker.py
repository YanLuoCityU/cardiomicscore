...
class PointEstimateEvaluator:
    ...
    def _load_model_data(self, predictor_list: list, outcome: str, data_split: str) -> pd.DataFrame:
        ...
        for predictor in predictor_list:
            ...
            path = "N/A"
            try:
                if predictor in ['AgeSex', 'Clinical', 'PANEL', 'PANELBlood']:
    ...
    def run_analysis(self):
        ...
        all_biomarkers = protein_biomarkers + metabolite_biomarkers
        predictor_sets = []
        ...
        if all_results:
            ...
            results_filename = os.path.join(self.cindex_save_dir, "cindex_individual_biomarker_summary.csv")
...
if __name__ == '__main__':
    ...
    log_filename = os.path.join(LOG_DIR, "CoxPH/Point_Estimates_Individual_Biomarker.log")
