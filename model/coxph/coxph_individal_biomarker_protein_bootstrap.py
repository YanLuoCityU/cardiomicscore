...
class BootstrapEvaluator:
    ...
    def run_analysis(self):
        ...
        all_biomarkers = protein_biomarkers
        predictor_sets = []
        ...
        if all_results:
            ...
            results_filename = os.path.join(self.save_dir, "cindex_individual_biomarker_protein_bootstrap_ci_summary.csv")
...
if __name__ == '__main__':
    ...
    log_filename = os.path.join(LOG_DIR, "CoxPH/Bootstrap_CI_Individual_Biomarker_Protein.log")
