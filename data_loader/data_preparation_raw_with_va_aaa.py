...
class UKBiobankData():
    def __init__(self,
        ...
        log_filename = join(log_prep_dir, f'UKBiobankData_raw_with_va_aaa_{self.seed}.log')
        self.logger = self._setup_logger(log_filename)
        
        self.split_seed_filename = f"split_seed_raw_with_va_aaa-{self.seed}"
        ...
        self.disease_list = ['cad', 'stroke', 'hf', 'af', 'va', 'pad', 'aaa', 'vte']
        self.disease_mapping = {
            'cad': 'Coronary artery disease', 'stroke': 'Stroke', 'vhd': 'Valvular heart disease',
            'hf': 'Heart failure', 'af': 'Atrial fibrillation', 'va': 'Ventricular arrhythmias',
            'pad': 'Peripheral artery disease', 'aaa': 'Abdominal aortic aneurysm', 'vte': 'Venous thromboembolism'
        }
