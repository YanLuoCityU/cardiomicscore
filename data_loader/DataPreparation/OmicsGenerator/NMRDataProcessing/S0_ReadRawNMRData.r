...
fwrite(nmr_ins0, file=file.path('/your path/cardiomicscore/data/processed/omics/metabolomics_ins0.csv'))
fwrite(biomarker_qc_flags, file=file.path('/your path/cardiomicscore/data/processed/omics/nmr_biomarker_qc_flags.csv'))
fwrite(sample_qc_flags, file=file.path('/your path/cardiomicscore/data/processed/omics/nmr_sample_qc_flags.csv'))
...
# load('nmr_info.rda')
# write.csv(nmr_info, '/your path/cardiomicscore/data/processed/omics/nmr_info.csv')
#################################################################################################