...
Code for the paper "[AI-based multiomics profiling reveals complementary omics contributions to personalized prediction of cardiovascular disease](https://www.nature.com/articles/s41467-026-68956-6)". This repository contains Python and R codes for data preprocessing, model training and evaluations, model interpretation, and visualization. Our demo website can be found [here](https://yanluocityu.github.io/cardiomicscore-website/).
...
- **English Version**: **[Download full-size PDF](https://github.com/YanLuoCityU/cardiomicscore/raw/main/src/comics_English.pdf)**
- **Chinese Version (中文版)**: **[Download full-size PDF](https://github.com/YanLuoCityU/cardiomicscore/raw/main/src/comics_Chinese.pdf)**
- **Poster Version**: **[Download full-size PDF](https://github.com/YanLuoCityU/cardiomicscore/raw/main/src/comics_poster.pdf)**

  [![Poster Preview](src/comics_poster_preview.jpg)](https://github.com/YanLuoCityU/cardiomicscore/raw/main/src/comics_poster.pdf)
